...
public class FasTestContainer extends TestContainer {

    public FasTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/fas/app.properties",
    ...
    public static class Common extends FasTestContainer {

        public static final FasTestContainer.Common INSTANCE = new FasTestContainer.Common();
